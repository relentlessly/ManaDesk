...
public class PipedTableExportText extends AbstarctExportTest {
	...
	public void testFull() {
		...
		assertEquals(
				"ID|NAME|COST|TYPE|POWER|TOUGHNESS|ORACLE|SET|RARITY|DBPRICE|LANG|RATING|ARTIST|COLLNUM|RULINGS|TEXT|ENID|GATHERERID|TCGID|PROPERTIES|COUNT|PRICE|COMMENT|LOCATION|CUSTOM|OWNERSHIP|SPECIAL|DATE",
				lines[0]);
		assertEquals(
				"-39|name 39|{4}|type 39|4|*|bla 39|set19|Common|1.42256411:3.2256411|Russian|2.39|Elena 39|39a||2bla <br> bla 39||0|0||5|2.1|comment 40|mem||true|foil,c=mint|Sun Jan 11 22:37:54 EST 2015",
				lines[1]);
	}
}
