...
public class MAWorkbenchMessages extends NLS {
	private static final String BUNDLE_NAME = "com.reflexit.magiccards_rcp.messages";//$NON-NLS-1$
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, MAWorkbenchMessages.class);
	}
}
