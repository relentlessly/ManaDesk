...
public interface MAWorkbenchPreferences {
	/**
	 * A named preference for how a new perspective should be opened when a new project is
	 * created.
	 * <p>
	 * Value is of type <code>String</code>. The possible values are defined by the constants
