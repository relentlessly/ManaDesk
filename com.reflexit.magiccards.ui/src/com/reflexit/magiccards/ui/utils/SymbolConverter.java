...
public class SymbolConverter {
	...
	static {
		...
		manaMap.put("{C}", "icons/mana/Symbol_C_mana.gif");
		...
		manaMap.put("{R/WP}", "icons/mana/Symbol_RWP_mana.gif");
		manaMap.put("{D}", "icons/mana/Symbol_D_mana.gif");
		manaMap.put("{C/B}", "icons/mana/Symbol_CB_mana.gif");
		manaMap.put("{C/R}", "icons/mana/Symbol_CR_mana.gif");
		manaMap.put("{C/W}", "icons/mana/Symbol_CW_mana.gif");
		manaMap.put("{C/U}", "icons/mana/Symbol_CU_mana.gif");
		manaMap.put("{C/G}", "icons/mana/Symbol_CG_mana.gif");
		manaMap.put("{CP}", "icons/mana/Symbol_CP_mana.gif");
		manaMap.put("{G/WP}", "icons/mana/Symbol_GWP_mana.gif");
		manaMap.put("{R/GP}", "icons/mana/Symbol_RGP_mana.gif");
		manaMap.put("{G/UP}", "icons/mana/Symbol_GUP_mana.gif");
