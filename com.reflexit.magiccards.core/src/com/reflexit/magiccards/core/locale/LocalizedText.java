...
public abstract class LocalizedText {
	...
	public static final Locale HEBREW = Locale.ENGLISH; // Partially supported
	public static final Locale LATIN = Locale.ENGLISH; // Partially supported
	public static final Locale ANCIENT_GREEK = Locale.ENGLISH; // Partially supported
	public static final Locale ARABIC = Locale.ENGLISH; // Partially supported
	public static final Locale SANSKRIT = Locale.ENGLISH; // Partially supported
	public static final Locale PHYREXIAN = Locale.ENGLISH; // Partially supported
	public static final Locale QUENYA = Locale.ENGLISH; // Partially supported
