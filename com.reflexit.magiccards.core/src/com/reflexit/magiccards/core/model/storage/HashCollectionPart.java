...
public class HashCollectionPart {
	private transient HashMap<String, Object> hash;
	 ...
	 */
	public synchronized IMagicCard getCard(String key) {
	...
	public synchronized IMagicCard getCard(IMagicCard card) {
		...
		if (obj instanceof LinkedList) {
			LinkedList<IMagicCard> linkedList = (LinkedList<IMagicCard>) obj;
			for (Object element : linkedList) {
				IMagicCard card2 = (IMagicCard) element;
	 ...
	 * @return
	 */
	public synchronized Collection<IMagicCard> getCards(String id) {
		Object obj = this.hash.get(id);
		if (obj == null) {
			return null;
		}
		if (obj instanceof IMagicCard) {
			LinkedList<IMagicCard> linkedList = new LinkedList<>();
			linkedList.add((IMagicCard) obj);
			return linkedList;
		}
		if (obj instanceof LinkedList) {
